...
#Here I will exclude movies from 2020 onwards to keep the date from looking off
horror_movies = horror_movies[horror_movies['year'] <= 2020]
...
plt.title('Average Popularity of Horror Movies by Decade(Up to 2019)')
plt.xlabel('Decade')
